            ...
            <div className="container">
               ...
               <div className="swiper testimonial-swiper" id="testimonialSwiper">
                  <div className="swiper-wrapper">
                     ...
                     <div className="swiper-slide testimonial-card" style={{backgroundImage:"url('/24.jpg"}}>
                        ...
                        <div className="testimonial-content">
                           ...
                           <p className="testimonial-text">“Working with several word the templates the last years only can
                              say
                              this is best every level
                              use it for my reviews that I hav already are company and reviews that I hav already are
                              company
                        ...
                        <div className="testimonial-thumbnail" style={{backgroundImage:"url('/24.jpg"}}>
                        </div>
                     </div>
                     ...
                     <div className="swiper-slide testimonial-card slide-expand"
                        ...
                        <div className="testimonial-thumbnail" style={{backgroundImage:"url('/23.jpg"}}>
                        </div>
                     </div>
                     ...
                     <div className="swiper-slide testimonial-card"
                        ...
                        <div className="testimonial-thumbnail" style={{backgroundImage:"url('/25.jpg"}}>
                        </div>
                     </div>
...
export default Home_testimonil