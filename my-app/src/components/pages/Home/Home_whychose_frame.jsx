...
const Home_whychose_frame = () => {
  return (
    <div>
      <div>
        <div className="bg-black/5 py-[8vw] md:px-[8vw] px-[2vw]">
          <div className=" md:flex">


            {/* Right side */}
            <div className="relative w-full flex flex-col justify-betweenmd:justify-start md:gap-[0.5vw] gap-[2vw] items-end px-[6vw] md:px-0 ">
              {/* Big frame */}
              <div className="">
                <img src={assets.why_choose_1} alt="" className="rounded-3xl md:w-[40.31vw] w-[90vw]" />
              </div>
              {/* small frame */}
              <div className="">
                  <img src={assets.why_choose_2} alt="" className="rounded-3xl md:w-[22.93vw] w-[50vw]" />
              </div>
        
                {/* vertical frame */}
                <div className="absolute bottom-0 md:left-0 left-7 bg-white md:pr-[0.5vw] md:pt-[0.5vw] pr-[2vw] pt-[2vw] rounded-4xl ">
                  <img src={assets.why_choose_3} alt="" className="rounded-4xl md:w-[17.37vw] w-[40vw]" />
                </div>
            ...
            {/* Left side */}
            <div className="w-full flex justify-center items-center pl-[5vw] my-[8vw] md:my-0 ">
              <div>
                <div>
                  ...
                  <p className="font_50 font-extrabold m_font_30">
                    Amazing Featured Tour <br className="hidden md:block"/>
                    Package The World
                  </p>
                </div>

                <div className="flex flex-col gap-[2vw] md:mt-[2vw] mt-[6vw]">
                  {/* Exclusive Trip */}

                  <div className="flex gap-[2vw]">
                        <div className='flex items-center'>
                        <div className="  md:h-[5vw] md:w-[5vw] h-[15vw] w-[15vw]   rounded-full relative group ">    
                           <div className="md:h-[5vw] md:w-[5vw] h-[15vw] w-[15vw]  p-[1vw] bg-[var(--primary)] rounded-full absolute md:top-[-5%] top-[-8%] md:left-[-5%] left-[-8%]  group-hover:top-[-8%] group-hover:left-[-8%] transition-all ease-out duration-600"></div>        

                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              className="bg-gray-100 p-[1vw] md:h-[5vw] md:w-[5vw] w-[15vw] h-[15vw] rounded-full absolute z-10"
                              viewBox="0 0 40 40"
                              fill="none"
                            >
                    ...
                    <div className=" pl-[1vw] flex ">
                      <p className="font_24 font-bold w-full m_font_21">Safety First Always</p>
                      <div class="border-l border-gray-500 h-24 mx-3 py-2"></div>
                      <p className="text-[#767676] font_16 m_font_16">
                        At Express Travel, we believe in the transformative
                        power of travel avid explorers ourselves.
                      </p>
                    </div>
                  </div>
                  {/* Professional guide */}
                  <div className="flex gap-[2vw]">
                        ...
                        <div className="  md:h-[5vw] md:w-[5vw] h-[15vw] w-[15vw] rounded-full relative group ">    
                           <div className="md:h-[5vw] md:w-[5vw] h-[15vw] w-[15vw]  p-[1vw] bg-[var(--primary)] rounded-full absolute md:top-[-5%] top-[-8%] md:left-[-5%] left-[-8%] group-hover:top-[-8%] group-hover:left-[-8%] transition-all ease-out duration-600"></div>     
                            <svg
                              ...
                              viewBox="0 0 39 40"
                              fill="none"
                              className="bg-gray-100 p-[1vw] md:h-[5vw] md:w-[5vw] h-[15vw] w-[15vw]  rounded-full absolute z-10"
                            >
                              <path
                    ...
                    <div className=" pl-[1vw] flex">
                      <p className="font_24 font-bold w-full  m_font_21">Adventure and Climbing</p>
                      <div class="border-l border-gray-500 h-24 mx-3 py-2"></div>
                      <p className="text-[#767676] font_16  m_font_16">
                        At Express Travel, we believe in the transformative
                        power of travel avid explorers ourselves.
                ...
                <div className="m_font_14 w-fit mt-[8vw] md:mt-[4vw] group bg-[var(--primary)] text-white md:px-6 md:py-4 px-[4vw] py-[2vw] rounded-full font-bold  hover:bg-black transition-all ease-out duration-300">
                  <span className="group-hover:pr-[1vw] transition-all ease-out duration-300">
                    Explore More{" "}
                  </span>
                  <sapn className=" "> ➺</sapn>
                </div>
...
export default Home_whychose_frame;
