...
const Home_about_us_frame = () => {
  return (
    <div>

            <div className="bg-white p-[8vw] font_16 m_font_16">
              <div className=" flex md:flex-row flex-col">
                {/* Right side */}
                <div className="relative w-full flex flex-col justify-between md:justify-start gap-[1vw] ">
                  {/* Big frame */}
                  <div className=''>
                    <img src={assets.md_frame_1} alt="" className="md:rounded-[1.5vw] rounded-[3vw] md:w-[26.25vw] w-[60vw]" />
                  </div>
                  {/* Vedio frame */}
                  <div className="md:w-[20vw] w-[40vw] md:h-[27vw] h-[60vw] md:rounded-[1.5vw] rounded-[3vw] absolute right-0 top-[20%] bg-gray-400 flex items-center">
                    <I_frame
                  ...
                  <div className="flex ">
                  {/* Design frame */}
                    <div className="pt-[1vw] pr-[1vw]">
                      <img src={assets.shape} alt="" className='md:w-[8.3vw] w-[20vw]'/>
                    </div>
                  {/* small frame */}
                    <div>
                      <img src={assets.sm_frame_1} alt="" className="md:rounded-[1.5vw] rounded-[3vw] md:w-[18vw] w-[50vw]" />
                    </div>
                  </div>
                ...
                {/* Left side */}
                <div className="w-full flex justify-center items-center md:pl-[5vw] pt-[10vw]">
                  <div>
                    <div>
                      <p className="montez font_33 text-[var(--primary)] m_font_24">About Us</p>
                    ...
                    <div className="flex flex-col gap-[2vw] mt-[2vw]">
                      {/* Exclusive Trip */}
        
                      <div className="flex md:gap-[2vw] gap-[6vw]">
                      ...
                      <div className="flex md:gap-[2vw] gap-[6vw]">
                        ...
                        <div>
                          <p  className="font_24 font-bold m_font_21">Professional Guide</p>
                          <p className="text-[#767676] font_16">
                            At Express Travel, we believe in the transformative power of
                            travel avid explorers ourselves.
                          </p>
                        </div>
                  ...
                  <div className="w-fit group bg-[var(--primary)] text-white md:px-[1.5vw] px-[3vw] md:py-[1vw] py-[2vw] mt-[10vw] md:mt-[4vw] rounded-full font-bold  hover:bg-black transition-all ease-out duration-300 m_font_14">
                    <span className="group-hover:pr-[1vw] transition-all ease-out duration-300">More About Us </span><span className=' '> ➺</span></div>
...
export default Home_about_us_frame